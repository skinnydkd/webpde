...
var PdeRoomManager = {
    ...
    return new Promise(function (resolve, reject) {
      ...
      roomRef.once('value').then(function (snap) {
        ...
        return roomRef.set(roomData).then(function () {
          ...
          try {
            localStorage.setItem('pde_room', JSON.stringify({
              code: code,
              playerId: hostId,
              isHost: true
            }));
  ...
  clearSavedRoom: function () {
    try {
      localStorage.removeItem('pde_room');
    } catch (e) {/* Intentional: localStorage unavailable in private browsing */}
  },
  // Cleanup: delete room
...
var PdeGameSounds = {
  play: function (type) {
    try {
      ...
      console.warn('PDE: Audio playback failed:', e.message || e);
    }
  }
};
...
const {
  useState: useStateGE,
  useEffect: useEffectGE,
  useRef: useRefGE,
  useCallback: useCallbackGE
} = React;

// ── Firebase Error Screen ───────────────────────────────────────
function PdeFirebaseError() {
  return /*#__PURE__*/React.createElement("div", {
    className: "min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-red-100 to-orange-100"
  ...
  }, "Firebase no configurat"), /*#__PURE__*/React.createElement("p", {
    className: "text-gray-600"
  }, "Cal configurar Firebase per jugar online. Edita ", /*#__PURE__*/React.createElement("code", {
    className: "bg-gray-100 px-2 py-1 rounded"
  }, "pde-game-engine.js"), " i substitueix ", /*#__PURE__*/React.createElement("code", {
    className: "bg-gray-100 px-2 py-1 rounded"
  }, "PDE_FIREBASE_CONFIG"), " amb les teues claus."), /*#__PURE__*/React.createElement("a", {
    href: "./",
    className: "inline-block px-6 py-3 bg-gray-200 rounded-xl font-bold hover:bg-gray-300"
  }, "\uD83C\uDFE0 Tornar")));
}

// ── Game Timer (circular countdown) ─────────────────────────────
function PdeGameTimer({
  seconds,
  onComplete,
  size = 80,
  color = '#ec4899',
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: `absolute font-black ${size > 60 ? 'text-xl' : 'text-sm'}`,
    style: {
      color: urgentColor
    }
  }, timeLeft));
...
// ── Game Leaderboard ────────────────────────────────────────────
function PdeGameLeaderboard({
  players,
  sortBy = 'score',
  maxVisible = 10,
  title = '🏆 Classificació'
}) {
  var sorted = Object.entries(players).map(function (entry) {
    return {
      id: entry[0],
      ...entry[1]
    };
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-lg font-black text-center mb-3"
  }, title), /*#__PURE__*/React.createElement("div", {
    className: "space-y-2"
  }, sorted.map(function (p, i) {
    return /*#__PURE__*/React.createElement("div", {
      key: p.id,
      className: 'flex items-center gap-3 px-3 py-2 rounded-xl transition-all ' + (i === 0 ? 'bg-yellow-100 scale-105' : i < 3 ? 'bg-gray-50' : '')
    }, /*#__PURE__*/React.createElement("span", {
      className: "text-xl w-8 text-center"
    }, medals[i] || i + 1), /*#__PURE__*/React.createElement("span", {
      className: "font-bold flex-1 truncate"
    }, p.name), /*#__PURE__*/React.createElement("span", {
      className: "font-black text-lg text-yellow-600"
...
function PdeGameLobby({
  ...
  var handleJoin = function () {
    ...
    PdeRoomManager.joinRoom(code, playerName.trim()).then(function (result) {
      ...
      if (e.message === 'ROOM_NOT_FOUND') setError('Sala no trobada. Revisa el codi.');else if (e.message === 'GAME_ALREADY_STARTED') setError('El joc ja ha començat!');else setError('Error: ' + e.message);
    });
  };
  ...
  var handleStart = function () {
    ...
    if (teamMode) {
      var connectedIds = Object.keys(players).filter(function (id) {
        return players[id].connected !== false;
      });
      var shuffled = connectedIds.sort(function () {
      ...
      PdeFirebase.ref('rooms/' + roomCode).update(updates).then(function () {
        PdeRoomManager.updateMeta(roomCode, {
          status: 'playing'
        });
  ...
  if (mode === 'choose') {
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: 'text-8xl ' + (gameEmoji ? '' : '')
    }, gameEmoji || '🎮'), /*#__PURE__*/React.createElement("h1", {
      className: "text-4xl font-black text-white"
    }, gameName), /*#__PURE__*/React.createElement("div", {
      className: "space-y-3"
    ...
    }, "\uD83D\uDCFA Crear Partida (Professor)"), /*#__PURE__*/React.createElement("button", {
      onClick: function () {
        setMode('join');
      },
      className: "w-full py-5 rounded-2xl bg-white text-gray-800 font-black text-xl shadow-lg hover:bg-gray-100"
    }, "\uD83D\uDCF1 Unir-se amb Codi")), /*#__PURE__*/React.createElement("a", {
      href: "./",
      className: "inline-block text-gray-500 hover:text-white transition-colors"
    }, "\uD83C\uDFE0 Tornar")));
  }
  ...
  if (mode === 'host' && !joined) {
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, gameEmoji || '📺'), /*#__PURE__*/React.createElement("h2", {
      className: "text-2xl font-black"
    }, "Crear Partida")), /*#__PURE__*/React.createElement("input", {
      type: "text",
      placeholder: "El teu nom (Professor)",
      value: playerName,
      onChange: function (e) {
      ...
      className: 'w-full py-4 rounded-2xl text-white font-black text-xl shadow-lg bg-gradient-to-r ' + (gameGradient || 'from-blue-500 to-purple-600') + (!playerName.trim() ? ' opacity-50 cursor-not-allowed' : '')
    }, "\uD83D\uDE80 Crear Sala"), /*#__PURE__*/React.createElement("button", {
      onClick: function () {
        setMode('choose');
      },
  ...
  if (mode === 'host' && joined && isHost) {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, gameEmoji, " ", gameName), /*#__PURE__*/React.createElement("p", {
      className: "text-xl text-gray-500 mt-2"
    }, "Esperant jugadors...")), /*#__PURE__*/React.createElement("div", {
      className: "grid md:grid-cols-2 gap-6"
    }, /*#__PURE__*/React.createElement("div", {
      className: "bg-white rounded-3xl p-6 text-center shadow-2xl"
    }, /*#__PURE__*/React.createElement("p", {
      className: "text-gray-500 font-bold mb-2"
    }, "CODI DE LA SALA"), /*#__PURE__*/React.createElement("p", {
      className: "text-5xl md:text-7xl font-black tracking-widest text-gray-800 font-mono"
    }, roomCode), /*#__PURE__*/React.createElement("p", {
      className: "text-sm text-gray-500 mt-3"
    }, "o escaneja el QR \u2192")), /*#__PURE__*/React.createElement("div", {
      className: "bg-white rounded-3xl p-6 text-center shadow-2xl flex flex-col items-center justify-center"
    }, /*#__PURE__*/React.createElement(PdeQRCode, {
      url: gameUrl,
      size: 180
    }), /*#__PURE__*/React.createElement("p", {
      className: "text-xs text-gray-500 mt-2 break-all"
    }, gameUrl))), /*#__PURE__*/React.createElement("div", {
      className: "bg-white/10 backdrop-blur rounded-3xl p-6"
    }, /*#__PURE__*/React.createElement("div", {
      className: "flex items-center justify-between mb-4"
    }, /*#__PURE__*/React.createElement("h3", {
      className: "text-xl font-black text-white"
    }, "\uD83D\uDC65 Jugadors (", playerCount, ")"), playerCount >= minPlayers && /*#__PURE__*/React.createElement("span", {
      className: "text-green-400 font-bold animate-pulse"
    }, "\u2705 Preparats!")), /*#__PURE__*/React.createElement("div", {
      ...
      return /*#__PURE__*/React.createElement("div", {
        key: id,
        className: "bg-white/20 rounded-xl px-3 py-2 text-white text-center"
      }, /*#__PURE__*/React.createElement("p", {
        className: "font-bold truncate"
      }, p.name), id === playerId && /*#__PURE__*/React.createElement("span", {
        className: "text-xs text-yellow-300"
      }, "\uD83D\uDC51 Host"));
    }))), /*#__PURE__*/React.createElement("button", {
      onClick: handleStart,
      disabled: playerCount < minPlayers,
      className: 'w-full py-5 rounded-2xl text-white font-black text-2xl shadow-lg bg-gradient-to-r ' + (gameGradient || 'from-green-500 to-emerald-600') + (playerCount < minPlayers ? ' opacity-50 cursor-not-allowed' : ' hover:brightness-110')
    }, playerCount < minPlayers ? '⏳ Mínim ' + minPlayers + ' jugadors' : '🚀 Començar Partida!')));
  }
  ...
  if (mode === 'join' && !joined) {
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "text-2xl font-black"
    }, "Unir-se")), /*#__PURE__*/React.createElement("input", {
      type: "text",
      placeholder: "Codi de la sala",
      value: inputCode,
      maxLength: 6,
      onChange: function (e) {
      ...
      className: 'w-full py-4 rounded-2xl text-white font-black text-xl shadow-lg bg-gradient-to-r ' + (gameGradient || 'from-blue-500 to-purple-600') + (!playerName.trim() || inputCode.length < 4 ? ' opacity-50 cursor-not-allowed' : '')
    }, "\uD83C\uDFAE Entrar!"), !urlRoom && /*#__PURE__*/React.createElement("button", {
      onClick: function () {
        setMode('choose');
      },
      className: "w-full text-gray-500 hover:text-gray-600"
  ...
  if (mode === 'join' && joined && !isHost) {
    ...
    }, "\u2705 Connectat!"), /*#__PURE__*/React.createElement("p", {
      className: "text-green-600 text-sm mt-1"
    }, "Esperant que el professor inicie la partida...")), /*#__PURE__*/React.createElement("div", {
      className: "bg-gray-100 rounded-xl p-3"
    }, /*#__PURE__*/React.createElement("p", {
      className: "text-gray-500 text-sm"
    }, "Sala: ", /*#__PURE__*/React.createElement("span", {
      className: "font-black"
    }, roomCode)), /*#__PURE__*/React.createElement("p", {
      className: "text-gray-500 text-sm"
    }, "Jugadors: ", /*#__PURE__*/React.createElement("span", {
      className: "font-black"
    }, playerCount)))));
  }
  return null;
...
function PdeDiceRoll({
  ...
  var faces = ['', '⚀', '⚁', '⚂', '⚃', '⚄', '⚅'];
  return /*#__PURE__*/React.createElement("div", {
    className: 'inline-flex items-center justify-center rounded-2xl bg-white shadow-lg ' + (isRolling ? 'animate-bounce' : ''),
    style: {
      width: size,
      height: size
    }
...
function PdeHostView({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: 'min-h-screen p-4 md:p-8 bg-gradient-to-br ' + (gradient || 'from-gray-900 to-gray-800')
  }, /*#__PURE__*/React.createElement("div", {
...
function PdePlayerView({
  children,
  gradient
}) {
  return /*#__PURE__*/React.createElement("div", {
    className: 'min-h-screen p-4 flex flex-col items-center justify-center bg-gradient-to-br ' + (gradient || 'from-gray-900 to-gray-800')
  }, /*#__PURE__*/React.createElement("div", {
